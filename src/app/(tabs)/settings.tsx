...
import { Card, SlideIn } from "@/components/ui";
import { theme } from "@/lib/theme";
import Constants from "expo-constants";
import { Info, Settings, Train } from "lucide-react-native";
        ...
        <SlideIn direction="bottom" delay={200}>
          <Card variant="default">
            ...
            <View className="items-center py-4 border-b border-border mb-4">
              <View className="w-16 h-16 rounded-2xl bg-primary/20 items-center justify-center mb-3">
                <Train size={28} color={theme.primary.DEFAULT} />
              </View>
